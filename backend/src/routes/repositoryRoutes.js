...
router.post("/:id/comments", requireAuth, requireRegisteredUser, addRepositoryComment);

// GET /api/repository/:id/comments -> list previous comments (faculty/coordinator only)
router.get("/:id/comments", requireAuth, requireRegisteredUser, listRepositoryComments);
